...
def draw_frame(
    ...
    gascmap = linear_cmap(0.2, 0.70, "cmr", "cmr.amber")
    ...
    sdense_cbar_ax = ax.inset_axes([0.04, 0.06, 0.30, 0.015])
    ...
    gas_cbar_ax = ax.inset_axes([0.04, 0.13, 0.30, 0.015])
